  ...
  return (
    <nav className={mergeClasses("bg-white dark:bg-gray-800 shadow-md px-8 py-4 flex", props.classNames?.nav)}>
      <ul className={mergeClasses("flex w-full gap-16 items-center", props.classNames?.nav_ul)}>
        <li><a href="/" className={mergeClasses("text-2xl text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100", props.classNames?.nav_ul_li)}>Home</a></li>
        <li><a href="/about" className={mergeClasses("text-2xl text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100", props.classNames?.nav_ul_li)}>About</a></li>
        <li><a href="/projects" className={mergeClasses("text-2xl text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100", props.classNames?.nav_ul_li)}>Projects</a></li>
        <li><a href="/contact" className={mergeClasses("text-2xl text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100 flex items-center gap-2", props.classNames?.nav_ul_li)}>
